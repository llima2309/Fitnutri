...
public class GlobalSecurityRequirementsOperationFilter : IOperationFilter
{
    ...
    public void Apply(OpenApiOperation operation, OperationFilterContext context)
    {
        ...
        if (path.StartsWith("users/me") ||path.StartsWith("perfis") || path.StartsWith("admin") || path.StartsWith("user/perfil") || path.StartsWith("agendamentos") || path.StartsWith("api/userprofile"))
        {
